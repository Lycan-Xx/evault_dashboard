...
import { Globe, PlugZap, Building, PhoneCall, ArrowLeft } from "lucide-react";
import clsx from "clsx";

const services = [
  { title: "9 mobile", description: "Recharge airtime", icon: PlugZap, image: "https://picsum.photos/id/1011/600/800" },
  { title: "Airtel", description: "Recharge airtime", icon: Globe, image: "https://picsum.photos/id/1025/600/800" },
  { title: "Glo", description: "Recharge airtime", icon: Building, image: "https://picsum.photos/id/1031/600/800" },
  { title: "M T N", description: "Recharge airtime", icon: PhoneCall, image: "https://picsum.photos/id/1045/600/800" },
];
      ...
      {!selectedService ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 min-h-[500px]">
          <div
            ...
            style={{
              backgroundImage: `url(${selectedService.image || "https://picsum.photos/600/800"})`,
            }}
          >
